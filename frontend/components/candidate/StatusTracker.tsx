    ...
    <div className="space-y-8">
      ...
      <Card className="border-brand-200 bg-brand-50/60 p-5">
        <h3 className="text-sm font-semibold text-slate-900">
          Đã được nhân viên cấp tài khoản?
        </h3>
        <p className="mt-2 text-sm leading-6 text-slate-600">
          Đăng nhập bằng số điện thoại để theo dõi hồ sơ từ bất kỳ máy nào, không
          phụ thuộc vào trình duyệt này nữa.
        </p>
        <div className="mt-4">
          <Button href="/tai-khoan/dang-nhap">Đăng nhập hệ thống khách hàng</Button>
        </div>
      </Card>
